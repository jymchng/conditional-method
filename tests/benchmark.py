...
The library is a C extension (``conditional_method._c``); there is no
pure-Python implementation to compare against. These benchmarks therefore
measure the C implementation's cost relative to plain Python baselines (no
decoration, manual if/else, plain decorators).
